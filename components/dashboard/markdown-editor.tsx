...
//   setIsPreviewVisible,
  ...
  return (
    <div className="inline-block h-full w-full overflow-hidden">
      <div className="flex h-max w-full items-center justify-between p-3.5 dark:bg-primary-900 md:static md:px-5">
      ...
      <label htmlFor="markdown-editor">
        <ScrollSyncPane>
          <textarea
            id="markdown-editor"
            className="bg-transparent h-full w-full resize-none p-4 pb-32 font-roboto-mono text-primary-700 focus-visible:outline focus-visible:outline-orange-secondary md:p-6 md:pb-60"
            value={content}
